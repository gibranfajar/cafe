        ...
        <div class="container text-center" style="margin-top: 6rem; margin-bottom: 10rem;">
            ...
            <div class="row justify-content-center">
                ...
                ?>
                    ...
                    <div class="col-6 col-lg-3 col-md-2 mt-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="card">
                            <img src="assets/img/<?= $value['menu_photo']; ?>" class="card-img-top" alt="coffee.jpg">
                            <div class="card-body">
                                <h5 class="card-title"><?= $value['nama_menu']; ?></h5>
                                <small>Rp. <?= $value['harga']; ?></small>
                                <a href="order/menu.php" class="btn btn-primary w-100">order</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
