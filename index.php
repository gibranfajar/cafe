...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center" data-aos="zoom-in" data-aos-delay="100">
      <h1 class="bg-white px-2 rounded">Welcome</h1>
      <h2 class="text-dark"><span class="bg-white px-1 rounded">Enjoy your coffee and please order</span></h2>
      <a href="order/form.php" class="btn-about">order</a>
    </div>
  </section><!-- End Hero -->
